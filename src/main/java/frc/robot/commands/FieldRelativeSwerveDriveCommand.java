...
public class FieldRelativeSwerveDriveCommand extends Command {

  DrivetrainSubsystem ds_DrivetrainSubsystem;

  Supplier<Double> f_XSpeedFunction, f_YSpeedFunction, f_RSpeedFunction;

  public FieldRelativeSwerveDriveCommand(DrivetrainSubsystem drivetrainSubsystem, Supplier<Double> xSpeedFunction, Supplier<Double> ySpeedFunction, Supplier<Double> rSpeedFunction){
